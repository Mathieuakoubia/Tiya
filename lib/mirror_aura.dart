          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text("2 min  •  Twin  •  Don d'Énergie",
                    style: TextStyle(
                        color: _accentPurple,
                        fontSize: 13,
              ...
              Text(
                "Le transfert d'attention bienveillante active les neurones miroirs et génère une réponse empathique mesurable. Visualiser l'énergie que l'on offre renforce autant le donneur que le receveur.",
                style: TextStyle(
                    fontSize: 15,
              ...
              _IntroStep(
                  number: "3",
                  text: "Son Aura change de couleur à chaque transfert"),
              const Spacer(),
              SizedBox(
